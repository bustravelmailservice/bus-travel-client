...
const TicketManagement = () => {
  ...
  const fetchTickets = useCallback(async () => {
    try {
      ...
      const response = await axios.get('https://bus-travel-1ffad4a532a5.herokuapp.com/api/all-tickets', {
        headers: {
  ...
  const toggleTicketStatus = async (id) => {
    try {
      ...
      await axios.put(`https://bus-travel-1ffad4a532a5.herokuapp.com/api/tickets/toggle/${id}`, null, {
        headers: {
          Authorization: `Bearer ${token}`
        }
      });
